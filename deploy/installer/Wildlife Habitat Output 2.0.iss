...
#define ExtensionName "Wildlife Habitat Output"
...
AppId={{008201D7-E506-4AF6-8916-0E28A0CEA257}
...
Source: {#BuildDir}\Landis.Extension.Output.WildlifeHabitat-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Wildlife Habitat Output 2.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Wildlife Habitat Output"" "; WorkingDir: {#LandisPlugInDir}
